  ...
  return (
    ...
    <header className='flex justify-between'>
      <div >
          ...
          <h1 className="lg:text-5xl md:text-4xl text-3xl lg:mt-12 md:mt-9 mt-5 font-bold">SR</h1>
          </div>
        </div>
        ...
        <button
            className="md:hidden hover:bg-transparent hover:text-[#e90074] inline-flex items-center justify-center p-2 rounded text-white focus:outline-none"
            onClick={toggleMenu}
          >
            {/* Hamburger icon */}
            <svg
